...
hypsometric_tint.generate_hypsometric_tint() for the current map
canvas extent.
...
def show_hypsometric_tint_dialog(iface):
    ...
    layer for the current map canvas extent if accepted. Returns the
    new layer, or None if the dialog was cancelled or no DEM layer
    was available to pick.
    """
