...
# D-4b, 2026-08-18: Land Unit's own sector 1/2 modifiers (Tables D-VI/
# D-VII) - the largest of the four Land layers by a wide margin, and the
# one that took real verification. See sidc.py's own MODIFIERS
# ["ground_unit"] comment for what went wrong trusting milsymbol/TSV
# sources directly here: 8 sector-1 codes where milsymbol's own
# _STD2525 ternary picks the wrong branch for MIL-STD-2525D, and both
# tables silently extended past where the real standard's tables stop
# (D-VI ends at 78, D-VII at 57 - not the 99/78 milsymbol defines).
_UNIT_SECTOR1_LABELS = {
    "airmobile_air_assault": "Airmobile/Air Assault",
    "area": "Area",
    "attack": "Attack",
    ...
    "mine_countermeasure": "Mine Countermeasure",
    "missile": "Missile",
    ...
    "security": "Security",
    "sensor": "Sensor",
    "sensor_control_module": "Sensor Control Module (SCM)",
    "signals_intelligence": "Signals Intelligence",
    "single_shelter_switch": "Single Shelter Switch",
    "single_rocket_launcher": "Single Rocket Launcher",
    "smoke": "Smoke",
    "sniper": "Sniper",
    "sound_ranging": "Sound Ranging",
    "special_operations_forces": "Special Operations Forces (SOF)",
    "special_weapons_and_tactics": "Special Weapons and Tactics",
    "survey": "Survey",
...
_UNIT_SECTOR2_LABELS = {
    ...
    "railroad": "Railroad",
    "recovery_unmanned_systems": "Recovery (Unmanned Systems)",
...
def add_land_unit_layer(iface, edition=None):
    ...
    return add_single_domain_point_layer(
        ...
        sector1_labels=_UNIT_SECTOR1_LABELS,
        sector2_labels=_UNIT_SECTOR2_LABELS,
        edition=edition,
    )
